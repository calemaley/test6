  ...
  return (
    <section className="section">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="service">Request Service</SelectItem>
                    ...
                    <FormControl>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="sollatek">Sollatek Protection</SelectItem>
                        </SelectContent>
                      </Select>
                    </FormControl>
                    <FormMessage />
        ...
        <div className="rounded-xl border bg-white p-6 shadow-sm">
          <div className="font-display text-lg font-bold text-primary">Our Offices</div>
          <div className="mt-2 text-foreground/70 text-sm">Lagos, Nigeria • Abuja • Port Harcourt</div>
          ...
          <div className="mt-6 text-sm text-foreground/70">
            Phone: +234 000 000 0000<br />Email: info@jbranky.com
          </div>
        </div>
      </div>
    </section>
