  ...
  return (
    <div className="bg-background">
      <section className="section">
        ...
        <p className="section-subtitle">Substations, switchgear, protection and grid interconnection.</p>
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {[
            ["Design & Build", "11kV–132kV substations, cable routing, grounding."],
            ["Testing & Commissioning", "Primary/secondary injection, relay settings, FAT/SAT."],
            ["Safety & Compliance", "IEC standards, arc-flash, thermography, audits."],
          ].map(([t, d]) => (
