    ...
    <div className="bg-background">
      <section className="section">
        ...
        <p className="section-subtitle">
          From feasibility to commissioning and maintenance.
        </p>
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {[
            [
              "Feasibility Studies",
              "Hydrological analysis, yield forecasts, EIA, ROI.",
            ],
            [
              "EPC Delivery",
              "Civil, electro-mechanical, protection & controls.",
            ],
            [
              "O&M",
              "Preventive maintenance, spares, performance optimization.",
            ],
          ].map(([t, d]) => (
